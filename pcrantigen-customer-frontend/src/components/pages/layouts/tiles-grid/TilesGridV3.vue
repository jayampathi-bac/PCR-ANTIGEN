      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//11.jpg"
                alt=""
                @error.once="
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//12.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//13.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
      ...
      <div class="tile is-ancestor">
        <div class="tile is-vertical is-8">
          <div class="tile">
            <div class="tile is-parent is-vertical">
              <a href="#" class="tile is-child tile-grid-item is-medium">
                <div class="tile-grid-item-inner">
                  <img
                    src="https://www.pngarts.com//14.jpg"
                    alt=""
                    @error.once="
                      $event.target.src = 'https://via.placeholder.com/400x300'
                    "
              ...
              <a href="#" class="tile is-child tile-grid-item is-medium">
                <div class="tile-grid-item-inner">
                  <img
                    src="https://www.pngarts.com//15.jpg"
                    alt=""
                    @error.once="
                      $event.target.src = 'https://via.placeholder.com/400x300'
                    "
            ...
            <div class="tile is-parent">
              <a href="#" class="tile is-child tile-grid-item is-large">
                <div class="tile-grid-item-inner">
                  <img
                    src="https://www.pngarts.com//16.jpg"
                    alt=""
                    @error.once="
                      $event.target.src = 'https://via.placeholder.com/400x300'
                    "
          ...
          <div class="tile is-parent">
            <a href="#" class="tile is-child tile-grid-item is-wide">
              <div class="tile-grid-item-inner">
                <img
                  src="https://www.pngarts.com//18.jpg"
                  alt=""
                  @error.once="
                    $event.target.src = 'https://via.placeholder.com/400x300'
                  "
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-tall">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//19.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-wide">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//20.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
        ...
        <div class="tile is-parent is-6">
          <a href="#" class="tile is-child tile-grid-item is-wide">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//23.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
      ...
      <div class="tile is-ancestor">
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//22.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//24.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
        ...
        <div class="tile is-parent">
          <a href="#" class="tile is-child tile-grid-item is-medium">
            <div class="tile-grid-item-inner">
              <img
                src="https://www.pngarts.com//27.jpg"
                alt=""
                @error.once="
                  $event.target.src = 'https://via.placeholder.com/400x300'
                "
