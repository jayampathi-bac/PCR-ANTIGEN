              ...
              <div class="section-content">
                <div class="experience-wrapper">
                  <div class="experience-item">
                    <img
                      src="https://www.pngarts.com//brands/airbnb.svg"
                      alt=""
                      @error.once="
                        $event.target.src =
                  ...
                  <div class="experience-item">
                    <img
                      src="https://www.pngarts.com//brands/facebook.svg"
                      alt=""
                      @error.once="
                        $event.target.src =
                          'https://via.placeholder.com/150x150'
                  ...
                  <div class="experience-item">
                    <img
                      src="https://www.pngarts.com//brands/atlassian.svg"
                      alt=""
                      @error.once="
                        $event.target.src =
                          'https://via.placeholder.com/150x150'
                  ...
                  <div class="experience-item">
                    <img
                      src="https://www.pngarts.com//brands/github.svg"
                      alt=""
                      @error.once="
                        $event.target.src =
                          'https://via.placeholder.com/150x150'
            ...
            <div class="profile-card-section no-padding">
              ...
              <div class="section-content">
                <div class="tools-wrapper">
                  ...
                  <!--Tool-->
                  <div class="tools-item">
                    <V-IconWrap picture="https://www.pngarts.com//brands/jira.svg" />
                  ...
                  <!--Tool-->
                  <div class="tools-item">
                    <V-IconWrap picture="https://www.pngarts.com//brands/office.svg" />
